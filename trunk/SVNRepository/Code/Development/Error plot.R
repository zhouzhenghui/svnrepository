...
par(mfrow=c(2,1))
data = read.table("parameter and SE data test.txt")
...
title(main = "Observed Intercept Parameter", cex.main=0.8)
...
axis(1, at = x, labels = data[,1], las = 2, cex.axis=0.7)
title(main = "Simulated Intercept Parameter", cex.main=0.8)
